...
const CHECKOUT_NEXT_PAGE_SLUG = "1/order/en/us/upsell1a";

function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/69a87cdf2f3ea5d0a979ad71-preview") ? value : (value.startsWith("/") ? "/69a87cdf2f3ea5d0a979ad71-preview" + value : "/69a87cdf2f3ea5d0a979ad71-preview/" + value);
  };
...
const getVrioCampaignInfoBasedOnPaymentMethod = (isVipUpsell) => {
    const vrioCampaigns = [{"_id":"698f8ea05dfb37cbef914367","integration":[{"_id":"68de8b4ba7998abc5f77b02a","workspace":"develop","platform":"vrio","description":"production","fields":{"publicApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg","internalApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg"},"status":"active","createdAt":1758437407128,"updatedAt":1759415115447,"__v":0,"category":"CRM","id":"68de8b4ba7998abc5f77b02a"}],"externalId":"242","name":"Akemi Detox Tea - Network - (1)","currency":"USD","countries":[223,38],"metadata":{"campaign_id":242,"campaign_name":"","payment_type_id":1,"campaign_active":true,"campaign_prepaid":true,"campaign_payment_method_required":true,"campaign_group_transactions":true,"campaign_global_js":"","campaign_global_seo_title":"","campaign_global_seo_keywords":"","campaign_global_seo_description":"","date_created":"2026-02-13 20:50:40","created_by":0,"date_modified":"2026-02-13 20:50:40","modified_by":0,"campaign_notes":"","offers":[],"shipping_profiles":[],"campaignId":"242","externalId":242,"description":"","payment_methods":["amex","discover","visa","master"],"alternative_payments":[],"countries":[{"iso_numeric":840,"calling_code":"1","id":223,"name":"United States of America","iso_2":"US","iso_3":"USA"},{"iso_numeric":124,"calling_code":"1","id":38,"name":"Canada","iso_2":"CA","iso_3":"CAN"}]},"funnels":[],"createdAt":1770900450405,"updatedAt":1771015840495,"packages":[],"status":"active","platform":"vrio","__v":0,"id":"698f8ea05dfb37cbef914367"}];
...
const DEFAULT_OFFER_ID = '240';
const getVrioOfferInfoByProductId = (productId) =>
  ((productId) => {
    const vrioOffers = [{"id":"240","offerTypeId":2,"name":"Akemi Detox Tea- VIP","items":[{"id":26,"name":"VIP Customer Benefits","quantity":1,"price":24.99,"shippable":false}],"description":""},{"id":"239","offerTypeId":1,"name":"Akemi Detox Tea - Network","items":[{"id":1699,"name":"1x Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1749,"name":"1x Pack of Detox Tea (28 Bags)","quantity":1,"price":0,"shippable":false},{"id":1700,"name":"2x Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1746,"name":"2x Pack of Detox Tea (56 Bags)","quantity":1,"price":0,"shippable":false},{"id":1701,"name":"3x Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1747,"name":"3x Pack of Detox Tea (84 Bags)","quantity":1,"price":0,"shippable":false},{"id":1698,"name":"Akemi Detox Tea","quantity":1,"price":0,"shippable":true},{"id":1703,"name":"Akemi Detox Tea  Journey Package Protection","quantity":1,"price":0,"shippable":false},{"id":1702,"name":"Akemi Detox Tea - 3 Year Warranty","quantity":1,"price":0,"shippable":false},{"id":1704,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1719,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1895,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1898,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1896,"name":"Special 2x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1899,"name":"Special 2x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1897,"name":"Special 3x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false},{"id":1900,"name":"Special 3x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false}],"description":""}];
...
const getPrices = () => {
  return [{"id":26,"name":"VIP Customer Benefits","quantity":1,"price":24.99,"shippable":false,"fullPrice":24.99,"finalPrice":24.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0},{"id":1699,"name":"1x Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1749,"name":"1x Pack of Detox Tea (28 Bags)","quantity":1,"price":0,"shippable":false,"fullPrice":28.83,"finalPrice":28.83,"productName":"1x Pack of Detox Tea (28 Bags)","discountAmount":0,"discountPercentage":0},{"id":1700,"name":"2x Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"2x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1746,"name":"2x Pack of Detox Tea (56 Bags)","quantity":1,"price":0,"shippable":false,"fullPrice":23.81,"finalPrice":23.81,"productName":"2x Pack of Detox Tea (56 Bags)","discountAmount":0,"discountPercentage":0},{"id":1701,"name":"3x Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3x Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1747,"name":"3x Pack of Detox Tea (84 Bags)","quantity":1,"price":0,"shippable":false,"fullPrice":20.72,"finalPrice":20.72,"productName":"3x Pack of Detox Tea (84 Bags)","discountAmount":0,"discountPercentage":0},{"id":1703,"name":"Akemi Detox Tea  Journey Package Protection","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Akemi Detox Tea  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"id":1702,"name":"Akemi Detox Tea - 3 Year Warranty","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Akemi Detox Tea - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"id":1704,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1719,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1895,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1898,"name":"Special 1x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1896,"name":"Special 2x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 2x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1899,"name":"Special 2x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 2x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1897,"name":"Special 3x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 3x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0},{"id":1900,"name":"Special 3x EXTRA Akemi Detox Tea","quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 3x EXTRA Akemi Detox Tea","discountAmount":0,"discountPercentage":0}]
};
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "JgSMuEQyXbc0_Kl2RrYI08NVovpyqqv5CE1Eb275PA8FrGiiFeNZ5LlNtDvd1nnV",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/69a87cdf2f3ea5d0a979ad71-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "ADT - Checkout", pageType: "Checkout" },
    };
